...
print("3. Mark of Athena")
print("4. House of Hades")
print("5.Blood of Olympus")
print("")
...
print("1. The Ruins of Gorlan")
print("2. The Burning Bridge")
print("3. The Icebound Land")
print("4. The Battle for Skandia")
print("5. The Sorcerer in the North")
print("6. The Siege of Macindaw")
print("7. Erak's Ransom")
print("8. The Kings of Clonmel")
print("9. Halt's Peril")
print("10. The Emperor of Nihon-Ja")
print("11. The Lost Stories")
print("")
...
print("14. Duel at Araluen")
print("15. The Missing Prince")
...
print("3. The Hunters")
print("(4. Slaves of Socorro")
print("5. Scorpion Mountain")
print("6. The Ghostfaces")
print("7. The Caldera")
