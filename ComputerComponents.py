...
print("Aritmetik ve mantıksal işlemleri yapar.") 
print("")
...
print("Önbellek olarak da bilinir")
print("Önbellek ne kadar büyük ise CPU’ nun performansı ve değeri o kadar artar.")
print("")
...
print(" 2. Veri Taşıma:")
print("Ram ve CPU arasında veri taşır.") 
print("")
...
print("Dizüstü ve masaüstü CPU’ lara göre fiyatları yüksektir.")
print("Yüksek işlem gücüne sahip bazı Platinum Sunucu CPU’larının fiyatları 10-15 bin dolar seviyesindedir.")
print("")
